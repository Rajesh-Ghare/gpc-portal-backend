...
const PERMISSIONS = [
  ['subject.view', 'View Subjects & Topics', 'subject'],
  ['subject.create', 'Create Subjects & Topics', 'subject'],
  ['subject.update', 'Update Subjects & Topics', 'subject'],
  ['subject.delete', 'Delete Subjects & Topics', 'subject'],
];
